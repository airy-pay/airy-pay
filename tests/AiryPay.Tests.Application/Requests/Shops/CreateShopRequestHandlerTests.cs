...
public class CreateShopRequestHandlerTests
{
    ...
    public CreateShopRequestHandlerTests()
    {
        ...
        var mockLogger = new Mock<ILogger<CreateShopRequestHandler>>();
        _handler = new CreateShopRequestHandler(_mockShopRepository.Object, appSettings, mockLogger.Object);
    }
